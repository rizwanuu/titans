...
const TextField: React.FC<TextFieldProps> = ({
  ...
  <div className="input">
    {/* {errors && (
      <span className="input__credentialError">
        {errors.map(error => error.message === "Please, enter valid credentials" ? error.message : "").join(" ")}
      </span>
    )} */}
    ...
    {errors && (
      <span className="input__error">
        {errors.map(error => error.message === "Please fill out this field." ? error.message : "").join(" ")}
      </span>
    )}
