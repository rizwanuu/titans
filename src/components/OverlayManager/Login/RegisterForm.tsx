        ...
        return (
          ...
          >
            ...
            <TextField
              ...
              label={intl.formatMessage(commonMessages.retypePassword)}
              type="password"
              required
            />
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <p className="file">1234</p>
              <TextField
                name="retypeNumber"
                autoComplete="Retype Number"
                label={intl.formatMessage(commonMessages.retypeCode)}
                type="text"
                required
              />
            </div>
