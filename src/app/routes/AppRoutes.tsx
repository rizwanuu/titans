...
import Login from "../../components/OverlayManager/Login/index";
import Password from "../../components/OverlayManager/Password/index";
...
export const Routes: React.FC = () => (
  <Switch>
    ...
    <Route path={paths.paymentUrl} component={Account} />
    <Route path={paths.trackingUrl} component={Account} />
    ...
    <Route path={paths.loginSignupPage} component={Login} />
    <Route path={paths.forgotPassword} component={Password} />
