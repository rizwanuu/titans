  ...
  return (
    <div className="address-book-container">
      <div className="titleGroup">
        <p className="title">
          <FormattedMessage defaultMessage="ADDRESS BOOK" />
        </p>
        <div className="new">
          <AddNewTile key="newTile" type="address" onClick={() => setDisplayNewModal(true)} />
        </div>
      </div>
      <div className="searchGroup">
        <div className="searchField">
          <input type="text" placeholder="Search Address Book" /><img src={searchImg} alt="searchicon"/>
        </div>
      </div>
      <AddressGrid
